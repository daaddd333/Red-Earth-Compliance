        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-20">
            ...
            <FAQItem
              ...
              answer={
                <>
                  <p>Australian workplace health and safety laws require employers to ensure electrical equipment used in the workplace is safe. For many workplaces, Test &amp; Tag is one of the most straightforward ways to manage that duty.</p>
      ...
      <section className="bg-sandstone/30 py-16 border-y border-sandstone">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4 w-full md:w-auto">
            <Link to="/contact" className="bg-primary hover:bg-[#E04F00] text-white transition-all duration-300 px-8 py-4 rounded font-bold uppercase tracking-widest text-sm flex items-center justify-center gap-3">
              Request Booking
            </Link>
          </div>
        </div>
